    ...
    },
    {
      ...
      content: (
        <>
          ...
          <ul className="help-list">
            <li><b>편집</b> — 본인 정보 또는 내가 추가한 인물만 수정 가능. 이름·생년월일·고인 여부·연락처·메모 외에, 배우자가 있는 경우 <b>결혼기념일</b>도 입력할 수 있습니다. 편집 화면에서 <b>🖼️ 아바타 선택</b>으로 노드 이미지를 지정할 수 있습니다.</li>
            <li><b>가족 추가</b> — 이 인물과 연결되는 새 가족 추가</li>
            <li><b>초대 링크 만들기</b> — 아직 가입하지 않은 생존 인물에게 초대 링크 발송</li>
          </ul>
          <div className="help-tip">💡 삭제 버튼은 아직 아무 계정에도 연결되지 않은 인물에게만 표시됩니다.</div>
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <div className="help-tip">💡 앱 첫 실행 시 뜨는 권한 요청에서 <b>허용</b>을 눌러야 알림을 받을 수 있습니다.</div>
        </>
      ),
    },
    {
